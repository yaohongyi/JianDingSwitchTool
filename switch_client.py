...
class SwitchClient(QtWidgets.QWidget):
    def __init__(self, *args, **kwargs):
        ...
        # 目录选择
        self.install_dir_label = QtWidgets.QLabel('选择鉴定目录：')
        ...
        grid_layout.addWidget(left_group_box, 0, 1, 5, 4)
        left_layout = QtWidgets.QGridLayout(left_group_box)
        left_layout.addWidget(self.edition_label, 0, 0, 1, 1)
        ...
        left_layout.addWidget(self.on_radio_button, 1, 2, 1, 1)
        left_layout.addWidget(self.install_dir_label, 2, 0, 1, 1)
        left_layout.addWidget(self.install_dir_qle, 2, 1, 1, 4)
        left_layout.addWidget(self.choose_path_button, 2, 5, 1, 1)
        left_layout.addWidget(self.prompt_label, 3, 0, 1, 6)
        grid_layout.addWidget(self.switch_button, 0, 5, 1, 1)  # 【切换版本】按钮
        grid_layout.addWidget(self.restart_button, 4, 5, 1, 1)  # 【重启鉴定】按钮
